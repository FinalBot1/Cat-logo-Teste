...
export function setupHighlight(scene, camera, renderer) {
  ...
  renderer.domElement.addEventListener("click", (event) => {
    ...
    /* =========================
       ACRÉSCIMO: destacar qualquer peça clicada
    ========================= */
    clickedObject.material?.emissive?.set(hoverColor);
    if (clickedObject.material?.emissive !== undefined) {
      clickedObject.material.emissiveIntensity = hoverIntensity;
      selectedMeshes.push(clickedObject);
    }
  ...
  spans.forEach(span => {
    ...
    span.addEventListener("click", () => {
      ...
      // ⚠️ Não aplicar emissive (não ascender) na peça da lista
    });
